...
print("\n\n")
dump(User.parse(["id": 2, "email": "user2@test.com"]))
print("\n\n")
dump(User.parse(["id": 3, "email": "user3@test.com", "dob": "21-07-1987"]))
print("\n\n")
dump(User.parse(["id": 4, "email": 1, "city": "London", "dob": "21-07-1987"]))
print("\n\n")
dump(User.parse(["id": 5, "city": 1, "dob": "21-07-1987"]))
print("\n\n")
dump(User.parse(["id": 6, "email": "user6@test.com", "city": "London", "dob": "21-07-1987"]))
print("\n\n")
dump(User.parse(["id": 7, "email": "user7@test.com", "city": "London", "dob": "21-07-1987", "food": ["name": 1]]))
print("\n\n")
dump(User.parse(["id": 8, "email": "user8@test.com", "city": "London", "dob": "21-07-1987", "food": ["namez": "pizza"]]))
print("\n\n")
dump(User.parse(["id": 9, "email": "user9@test.com", "city": "London", "dob": "21-07-1987", "food": ["name": "pizza"]]))
print("\n\n")
dump(User.parse(["id": 10, "email": "user10@test.com", "city": "London", "dob": "21-07-1987", "food": ["name": "pizza"], "fallback": "string"]))
print("\n\n")
dump(User.parse(["id": 11, "email": "user11@test.com", "city": "London", "dob": "21-07-1987", "food": ["name": "pizza"]]))
print("\n\n")
dump(User.parse(["id": 12, "email": "user12@test.com", "city": "London", "dob": "21-07-1987", "food": ["name": "pizza"], "fallback": [["name": "burgers"], ["name": "sushi"]]]))
